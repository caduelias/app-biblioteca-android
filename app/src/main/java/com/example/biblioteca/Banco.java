...
public class Banco {
    ...
    //Singleton -> Intannciar a classe BancoDeDados na memoria, e garant que ela sera instanciada uma unica vez.
    ...
    public void abrirBanco(Context context) {
        ...
        bancoDados = context.openOrCreateDatabase("dbBiblioteca.db",
